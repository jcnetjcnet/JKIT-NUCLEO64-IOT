...
#define USE_ESP32_AT true //by isjeon
////////////////////////////////////////

#define ESP_AT_LIB_VERSION              "ESP_AT_Lib v1.5.1"

#ifndef ESP_AT_LIB_DEBUG_OUTPUT
//by isjeon  #define ESP_AT_LIB_DEBUG_OUTPUT       Serial
#endif
...
#endif
#else
    #define SERIAL_RX_BUFFER_SIZE     2048 //by isjeon
#endif
...
//by i//by isjeon    ESP8266(Stream* uart = &Serial);sjeon    ESP8266(Stream* uart = &Serial);
    ESP8266();
    ////////////////////////////////////////
#if 0
    Stream* getUart()
...
//by isjeon    Stream *m_puart; /* The UART to communicate with ESP_AT */
    Serial *m_puart;
    onData m_onData;
    void*  m_onDataPtr;
};
